  ...
  return (
    <div>
      ...
      <div className="max-w-2xl">
        ...
        <h2 className="text-slate-800 dark:text-aa-100 purple:text-pt-100 py-6 text-xl font-semibold tracking-md border-b border-slate-200 dark:border-aa-600 purple:border-pt-800">
