  ...
  return (
    <div>
      ...
      <div className="max-w-2xl">
        <div className="bg-slate-100 dark:bg-aa-600 purple:bg-pt-800 text-slate-500 dark:text-aa-200 purple:text-pt-200 py-6 px-8 text-sm font-semibold tracking-sm rounded-lg">
          White Labelling features are a paid Add-on.{' '}
          <a href="#" className="text-indigo-700 dark:text-aa-400 purple:text-pt-400">
            Compare plans
          </a>
        </div>
        <h2 className="text-slate-800 dark:text-aa-200 purple:text-pt-200 py-6 text-xl font-semibold tracking-md border-b border-slate-200 dark:border-aa-600 purple:border-pt-800">
          White Labeling settings
        </h2>
        <div className="py-6 border-b border-slate-200 dark:border-aa-600 purple:border-pt-800">
          <Toggle
