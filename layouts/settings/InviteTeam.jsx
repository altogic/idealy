...
export default function InviteTeam() {
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between lg:gap-4 pb-4 mb-10 lg:mb-11 lg:border-b lg:border-slate-200 dark:border-aa-600 purple:border-pt-600">
      ...
      {getCompanyMembersLoading ? (
        ...
        <div>
          <div className="flex items-center justify-between pl-4 pr-[7rem] pb-4 mb-11 border-b border-slate-200 dark:border-aa-600 purple:border-pt-600">
