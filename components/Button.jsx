    ...
    <button
      ...
      className={cn(
        ...
        variant === 'red'
          ...
          : '',
        variant === 'indigo'
          ? 'bg-indigo-700 dark:bg-aa-700 purple:bg-pt-700 text-white dark:text-aa-100 purple:text-pt-100 border-transparent dark:border-aa-600 purple:border-pt-800 hover:bg-indigo-600 dark:hover:bg-aa-500 purple:hover:bg-pt-600'
          : ''
      )}
      {...props}
