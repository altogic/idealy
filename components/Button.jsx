    ...
    <button
      ...
      className={cn(
        ...
        variant === 'blankRed'
          ...
          : '',
        variant === 'red'
          ? 'py-2.5 px-4 bg-red-600 dark:bg-red-800 purple:bg-red-800 text-white dark:text-aa-100 purple:text-pt-100 border-transparent hover:bg-red-500 dark:hover:bg-red-700 purple:hover:bg-red-700'
          : '',
        variant === 'indigo'
