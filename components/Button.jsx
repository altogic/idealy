  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === 'blank'
          ? 'py-2.5 px-4 bg-white dark:bg-aa-400 purple:bg-pt-400 text-gray-700 dark:text-aa-100 purple:text-pt-100 border-gray-300 hover:bg-gray-100'
          : '',
        variant === 'blankRed'
          ...
          : '',
        variant === 'red'
          ? 'py-2.5 px-4 bg-red-600 dark:bg-red-900 purple:bg-red-900 text-white border-transparent hover:bg-red-700'
          : '',
        variant === 'indigo'
