        ...
        <div className="grow flex flex-col">
          <div className="flex justify-between items-center gap-2 divide-x divide-slate-200 dark:divide-aa-600 purple:divide-pt-600">
            <div className=" h-6 w-[44rem]">
              <div className="animate-pulse rounded-md bg-gray-200 w-3/4 h-full" />
            </div>

            <div className="hidden md:block">
              <div className="h-4 w-20 animate-pulse rounded-md bg-gray-200 ml-2" />
            </div>
            <div className="hidden md:block">
          ...
          <div className="mt-2 mb-8 h-4 w-32 animate-pulse rounded-md bg-gray-200" />
            ...
            {Array.from({ length: 7 }, () => Math.floor(Math.random() * 21) + 80).map(
              (width, index) => (
                <div
                  ...
                  className="w-[var(--announcement-width)] h-4 animate-pulse rounded-md bg-gray-200"
                />
              )
            )}
          </div>
