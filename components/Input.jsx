      ...
      <div className={cn(`relative`)}>
        ...
        <div className={`flex ${type === 'checkbox' ? 'items-center' : ''} `}>
          <input
            id={id}
            className={cn(
              'block w-full h-11 bg-white dark:bg-aa-800 purple:bg-pt-800 text-slate-800 dark:text-aa-200 purple:text-pt-200 py-2.5 text-base tracking-sm border border-gray-300 dark:border-aa-600 purple:border-pt-600 rounded-md placeholder:text-slate-500 dark:placeholder-aa-200 purple:placeholder-pt-200 focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-aa-400 dark:focus:border-aa-400 purple:focus:ring-pt-400 purple:focus:border-pt-400',
