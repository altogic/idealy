...
export default function Notifications() {
  ...
  const userNotifications = useSelector((state) => state.notification.unreadUserNotifications);
  const companyNotifications = useSelector(
    (state) => state.notification.unreadCompanyNotifications
  );
  const [notifications, setNotifications] = useState([]);
  useEffect(() => {
    setNotifications([...userNotifications, ...companyNotifications]);
  }, [userNotifications.companyNotifications, companyNotifications]);
  return (
