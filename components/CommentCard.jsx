          ...
          {isReplying && (
            <div className="w-full">
              <textarea
                ...
                name="type-a-comment"
                rows={5}
                className="block w-full bg-white dark:bg-aa-800 purple:bg-pt-800 text-slate-500 dark:text-aa-200 purple:text-pt-200 text-base tracking-sm border border-gray-300 dark:border-aa-400 purple:border-pt-400 rounded-md placeholder:text-slate-500 dark:placeholder-aa-200 purple:placeholder-pt-200 focus:border-indigo-500 focus:ring-indigo-500 dark:focus:ring-aa-400 dark:focus:border-aa-400 purple:focus:ring-pt-400 purple:focus:border-pt-400"
