...
export default function PublicView() {
  ...
  return (
    <>
      <Head>
        <title>Altogic Canny Alternative Public Roadmap</title>
        <meta name="description" content="Altogic Canny Alternative Public Roadmap" />
      </Head>
      <Layout>
        <div className="max-w-screen-lg mx-auto my-16">
          <div className="flex items-start justify-between mb-16">
            <div>
              <h1 className="text-slate-800 mb-2 text-3xl font-semibold">Roadmap</h1>
              <p className="text-slate-600 text-base tracking-sm">Roadmap description here....</p>
            </div>
          </div>
          <div className="flex gap-8">
            <div className="p-6 border border-slate-200 rounded-lg shadow">
              <div className="flex items-center gap-2 text-slate-700 text-base tracking-sm">
